        ...
        <div class="row border rounded-5 p-3 bg-white shadow box-area">
            <div class="col-md-6 rounded-4 left-box d-flex justify-content-center align-items-center">
                <div class="featured-image">
                    <img src="<?= base_url('assets/img/kelas.svg')?>" class="img-fluid" style="width:350px;">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-wrap">
                    ...
                    <div class="form">
                        <form action="<?= base_url('/kelas/store');?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <?php endif; ?>
                                <input type="number" id="floatingInput" class="form-control <?= session('validation') ? 'is-invalid' : '' ?>" placeholder="Kapasitas Ruangan" name="kapasitas" value="<?= old('kapasitas') ?>">
